...
// Server-specific dependencies - these are optional and injected from server
...
export class LinearOrchestrator implements IWorkflowOrchestrator {
  ...
  private _agUiAdapter?: any; // AgUiEventAdapter from server
  private _lifecycleService?: any; // ExecutionLifecycleService from server
